...
JLabel A1 = new JLabel ("Home");
 ...
 JLabel SUP = new JLabel ("SING UP");
        SUP.setBounds(93,336,87,23); 
        SUP.setForeground(Color.WHITE);
    add(SUP);
   Font SiUP = new Font ("calibri",Font.BOLD,16);
        SUP.setFont(SiUP);

 JLabel Log = new JLabel ("LOGIN");
        Log.setBounds(96,371,87,23); 
        Log.setForeground(Color.WHITE);
    add(Log);
   Font Logg = new Font ("calibri",Font.BOLD,16);
        Log.setFont(Logg);
...
//------------------------------------------------------------------------------------------------------------------------------           
    ...
    JLabel a1 = new JLabel();
           a1.setBounds(80,335,87,25);
           a1.setIcon(new ImageIcon(getClass().getResource("Icons/Sing Up.png")));      
       add(a1);
    ...
    JLabel a3 = new JLabel();
           a3.setBounds(80,370,87,25);
           a3.setIcon(new ImageIcon(getClass().getResource("Icons/Login.png")));      
       add(a3);
                  ...
                  for (int i = -100; i < 100; i=i+14) {
            		{
                        ...
                        a.setIcon(new ImageIcon(getClass().getResource("Home/"+lk+".jpg")));
		     try {
                        sleep(50);
