 ...
 * @author Blocker
 */
class Students_login extends JFrame{
...
//------------------------------------------------------------------------------------------------------------------------------
    ...
    JLabel l1 = new JLabel ("New Student ?");
    ...
    JLabel la = new JLabel ("To Enter The Students ");
...
JPasswordField t2 = new JPasswordField();
    ...
    JLabel l3 = new JLabel ("User Name / Student ID");
   ...
   Font Atel3 = new Font ("calibri",Font.PLAIN,17);
    ...
    JLabel QQ = new JLabel();
           QQ.setIcon(new ImageIcon(getClass().getResource("S_Frame/QQ.png")));
   ...
   Font AteV3 = new Font ("calibri",Font.PLAIN,17);
    ...
    JLabel VV = new JLabel();
           VV.setIcon(new ImageIcon(getClass().getResource("S_Frame/VV.png")));
...
//------------------------------------------------------------------------------------------------------------------------------
    ...
    JLabel qL = new JLabel();
           qL.setIcon(new ImageIcon(getClass().getResource("S_Frame/Login.png")));
                  ...
                  for (int i = -100; i < 100; i=i+14) {
            		{
                        ...
                        I.setIcon(new ImageIcon(getClass().getResource("S_Frame/"+lk+".png")));
...
public void mouseEntered(MouseEvent e) {  
qL.setIcon(new ImageIcon(getClass().getResource("S_Frame/login Y.png")));
...
Cle.addMouseListener(new MouseAdapter() {
      ...
      S_FORGET_PASSWORD Frame = new S_FORGET_PASSWORD();
     dispose();          
 ...
 qL.addMouseListener(new MouseAdapter() {
   ...
   if(t1.getText().isEmpty() && t2.getText().isEmpty()){
       ...
       try{
            ...
            ResultSet rs=st.executeQuery("SELECT * FROM students WHERE students_id = '"+t1.getText()+ "' && password ='"+t2.getText()+"'");
    
    
      if(rs.next()){
           
            xx = rs.getString("students_id");
...
//     Student_frame Frame = new Student_frame();
           dispose();
