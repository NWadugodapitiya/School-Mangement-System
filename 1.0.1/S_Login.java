...
JButton b6 = new JButton ("Back");
    ...
    add(b6);
     ...
     S_Registrasion Frame = new S_Registrasion();
     dispose();
...
b5.addActionListener(new ActionListener(){
   public void actionPerformed(ActionEvent e){
       ...
       if(t1.getText().isEmpty() && t2.getText().isEmpty()){
        l3.setText("Type Item Student ID and Password");
       }
       else{    
       ...
       try{
            ...
            ResultSet rs=st.executeQuery("SELECT * FROM s_registrasion WHERE Student_ID = '"+t1.getText()+ "' && Password ='"+t2.getText()+"'");
    
    
      if(rs.next()){
          
           xx = rs.getString("Student_ID");
           ...
           l3.setText("Invalid Student ID or Password");
       }    
       }
...
setUndecorated(true);
setBackground(new Color(80,200,180,250));
setVisible(true); 
   }
