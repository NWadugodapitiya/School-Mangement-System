 ...
 * @author Ashen
 */
public class T_Grade extends JFrame{
...
b1.setBackground(new Color(150,250,0,250));
  }
});
...
public void mouseEntered(MouseEvent e) {  
b2.setBackground(new Color(150,250,0,250));
  }
});
...
public void mouseEntered(MouseEvent e) {  
b3.setBackground(new Color(150,250,0,250));
  }
});
...
b1.addMouseListener(new MouseAdapter() {
     ...
     T_studentDetails Frame = new T_studentDetails();
     dispose();
...
b2.addMouseListener(new MouseAdapter() {
           public void mouseClicked(MouseEvent e) {
     T_Details_T Frame = new T_Details_T();
     dispose();
...
b4.addMouseListener(new MouseAdapter() {
    ...
    JLabel a11 = new JLabel();
           a11.setIcon(new ImageIcon(getClass().getResource("image/lite.png")));
           a11.setBounds(200,0,400,400);
       add(a11);   
...
setUndecorated(true);
setBackground(new Color(150,250,0,250));
setVisible(true); 
   }
