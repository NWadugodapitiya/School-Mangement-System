...
public class Teachers_library extends JFrame {
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        i1.setIcon(new ImageIcon(getClass().getResource("Teachers/Dashboard.png")));
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        Object[] columns = {"Book Name","More days","Date taken","Until when"};
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        a.setIcon(new ImageIcon(getClass().getResource("Teachers_library/Main – 1.png")));
        add(a);
//------------------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------------------------------------------------
