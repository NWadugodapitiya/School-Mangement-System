...
public class Students_settings extends JFrame {
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        update.setIcon(new ImageIcon(getClass().getResource("Students_settings/Update.png")));
        update.setBounds(628,451,104,28);
        add(update);

        JLabel updatex = new JLabel();
        updatex.setIcon(new ImageIcon(getClass().getResource("Students_settings/Update_B.png")));
        add(updatex);
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        a2.setIcon(new ImageIcon(getClass().getResource("Students_settings/exit.png")));
        add(a2);
//------------------------------------------------------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        login.setIcon(new ImageIcon(getClass().getResource("Students_settings/Logout.png")));
        login.setBounds(24,450,105,29);
        add(login);

        JLabel loginx = new JLabel();
        loginx.setIcon(new ImageIcon(getClass().getResource("Students_settings/Logout x.png")));
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        i1.setIcon(new ImageIcon(getClass().getResource("Students_settings/Dashboard.png")));
        i1.setBounds(34,99,15,15);
        add(i1);

        JLabel i2 = new JLabel();
        i2.setIcon(new ImageIcon(getClass().getResource("Students_settings/Teachers.png")));
        i2.setBounds(37,139,14,17);
        add(i2);

        JLabel i3 = new JLabel();
        i3.setIcon(new ImageIcon(getClass().getResource("Students_settings/Exam.png")));
        ...
        i5.setIcon(new ImageIcon(getClass().getResource("Students_settings/B Settings.png")));
...
//======================================================================================================================
        T1.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                i1.setIcon(new ImageIcon(getClass().getResource("Students_settings/B Dashboard.png")));
...
//======================================================================================================================
        T2.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                i2.setIcon(new ImageIcon(getClass().getResource("Students_settings/B Teachers.png")));
...
//======================================================================================================================
        T3.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                i3.setIcon(new ImageIcon(getClass().getResource("Students_settings/B Exam.png")));
...
//======================================================================================================================
        ...
        ai.setIcon(new ImageIcon(getClass().getResource("Students_settings/AI2.png")));
        ...
        ai.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                ...
                ai.setIcon(new ImageIcon(getClass().getResource("Students_settings/AI.png")));
...
//======================================================================================================================
        ...
        proadd.setIcon(new ImageIcon(getClass().getResource("Students_settings/add.png")));
        add(proadd);

        JLabel prof = new JLabel();
        prof.setIcon(new ImageIcon(getClass().getResource("Students_settings/profile 01.png")));
        prof.setBounds(815,52,72,72);
        add(prof);

        JLabel profl = new JLabel();
        profl.setIcon(new ImageIcon(getClass().getResource("Students_settings/profile.png")));
        add(profl);
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        a.setIcon(new ImageIcon(getClass().getResource("Students_settings/Main – 1.png")));
        add(a);
//------------------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------------------------------------------------
