 ...
 JPanel p1 = new JPanel();
   ...
   Font Atelc4 = new Font ("calibri",Font.PLAIN,20);
    ...
    JLabel lc5 = new JLabel ("");
           ...
           lc5.setBounds(383,204,70,25);
       add(lc5);
   Font Atelc5 = new Font ("calibri",Font.PLAIN,20);
           lc5.setFont(Atelc5);        
      
    
    JLabel ld1 = new JLabel ("Change Password      =");
...
JPasswordField td1 = new JPasswordField();
...
try{
            ...
            pst = (PreparedStatement) con.prepareStatement("update students set Password=?");
