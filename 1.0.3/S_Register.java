 ...
 * @author Ashen_NW
 */
public class S_Register extends JFrame{
...
setLayout(null);
 ...
 JPanel p1 = new JPanel();
   ...
   add(p1);  
    ...
    JLabel la = new JLabel ("Student Registrasion");
   ...
   Font Atel2 = new Font ("calibri",Font.PLAIN,20);
    ...
    JLabel l31 = new JLabel ("Grade And Class");
...
JPasswordField t5 = new JPasswordField();
 ...
 JPanel p = new JPanel();
        ...
        p.setBackground(new Color(100,80,200,250));
    add(p);
...
b2.addActionListener(new ActionListener(){
   public void actionPerformed(ActionEvent e){
       ...
       if(t1.getText().isEmpty()){
        l6.setText("Type Item Student ID");
       ...
       try{
            ...
            String query = "insert into students (Students_ID,Name,Grade,Class,Password,Date_Of_Birth,Adress,T_Number1,T_Number2,Add1)" + " values (?,?,?,?,?,?,?,?,?,?)";
  ...
  JOptionPane.showMessageDialog(null, "Student Registrasion success","Registrasion ok ",JOptionPane.WARNING_MESSAGE);
