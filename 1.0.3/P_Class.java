...
setLayout(null);
 ...
 JLabel l3 = new JLabel ("Add");
        l3.setBounds(38,85,100,20);
        l3.setForeground(Color.white);
 p3.add(l3);
 
 JLabel pi3 = new JLabel();
        pi3.setIcon(new ImageIcon(getClass().getResource("P_Class/add icon.png")));
        pi3.setBounds(-4,10,85,85); 
 p3.add(pi3);  
 ...
 JLabel l4 = new JLabel ("Red Book");
        l4.setBounds(23,88,100,20);
        l4.setForeground(Color.RED);
 p4.add(l4);

 JLabel pi4 = new JLabel();
        pi4.setIcon(new ImageIcon(getClass().getResource("P_Class/Red Book.png")));
        pi4.setBounds(18,5,85,85); 
 p4.add(pi4); 
 ...
 JLabel l5 = new JLabel ("Add");
        l5.setBounds(38,85,100,20);
        l5.setForeground(Color.white);
 p5.add(l5);
 
 JLabel pi5 = new JLabel();
        pi5.setIcon(new ImageIcon(getClass().getResource("P_Class/add icon.png")));
        pi5.setBounds(-4,10,85,85); 
 p5.add(pi5); 
