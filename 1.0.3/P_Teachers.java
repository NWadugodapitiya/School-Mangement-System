...
p1.setBackground(new Color(46,42,43,250));
 ...
 JLabel pl1 = new JLabel ("Teachers");
        pl1.setBounds(22,75,100,20);
        pl1.setForeground(Color.WHITE)    ;
 p1.add(pl1);
 
 
 JLabel pl2 = new JLabel ("Details");
        pl2.setBounds(30,90,100,20);
        pl2.setForeground(Color.WHITE);
 p1.add(pl2);
            
    JLabel pi1 = new JLabel();
           pi1.setIcon(new ImageIcon(getClass().getResource("P_Class/teachers d.png")));
           pi1.setBounds(6,10,85,85); 
    p1.add(pi1); 
...
public void mouseExited(MouseEvent e) {  
 ...
 p3.add(l3);
    ...
    JLabel pl3 = new JLabel();
           pl3.setIcon(new ImageIcon(getClass().getResource("P_Class/add icon.png")));
           pl3.setBounds(-4,10,85,85); 
    p3.add(pl3); 
...
l3.setForeground(Color.white);   
 ...
 p4.add(l4);
    ...
    JLabel pi4 = new JLabel();
           pi4.setIcon(new ImageIcon(getClass().getResource("P_Class/comming soon.png")));
           pi4.setBounds(10,-3,100,100); 
       p4.add(pi4);
